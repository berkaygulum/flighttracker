...
INSERT INTO "new_PriceRecord" ("airline", "departureTime", "flightDate", "flightNumber", "id", "priceEUR", "priceTRY", "recordedAt", "routeId") SELECT "airline", "departureTime", "flightDate", "flightNumber", "id", "priceEUR", "priceTRY", "recordedAt", "routeId" FROM "PriceRecord";
